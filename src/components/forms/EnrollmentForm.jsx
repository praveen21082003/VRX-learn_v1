...
function EnrollmentForm({ initialData, onClose, onSuccess, mode, isEdit }) {
    ...
    // console.log(MODULE_ACCESS_DATA);
    ...
    const ModuleAccessList = (
        <div>
            {!isEdit && !formData.courseId ? (
                ...
                <div className="text-center text-caption text-danger py-6">
                    {modulesError || error}
                </div>
                    ...
                    <div className="flex justify-between border-t border-default">
                        ...
                        <div className="flex gap-2 items-center py-3">
                            ...
                            <Button
                                ...
                                buttonName={creating || updating ? "Processing..." : isEdit ? "Save Changes" : "Add Enrollment"}
