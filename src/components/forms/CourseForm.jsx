...
function CourseForm({ initialData, onClose, onSuccess, mode }) {
  ...
  const handleChange = (field, value) => {
    ...
    if (field === "shortDescription") {
      ...
      if (trimmed && trimmed.length > 600) {
        setWarning((prev) => ({
          ...prev,
          shortDescription: `Max 600 characters (${trimmed.length}/600)`,
        }));
      }
    }
    ...
    if (field === "longDescription") {
      ...
      if (trimmed && trimmed.length > 5000) {
        setWarning((prev) => ({
          ...prev,
          longDescription: `Max 5000 characters (${trimmed.length}/5000)`,
        }));
      }
    }
  };
      ...
      <DeleteConfirmContent
        ...
        message={
          <span>
            ...
            . All associated materials, student progress, and data tied to this
            course will be permanently erased from the system.
          </span>
        }
        loading={deleting}
        onClose={onClose}
      ...
      {!isOpen && (
        ...
        >
          <label className="text-h5">
            Add Long Description<span className="text-caption">(optional)</span>
          </label>
