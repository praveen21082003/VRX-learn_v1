    ...
    return (
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <p className="text-h45 text-center text-muted max-w-xl">
          We are almost finished setting up your account. Please do not close or
          refresh this window.
        </p>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      ...
      <Button
        ...
        className="px-6 py-2 rounded-lg w-full max-w-xl"
        onClick={() => {
          const email = "sales@vrnexgen1.com";

          const subject = encodeURIComponent("Signup Verification Issue");

          const body = encodeURIComponent(`Hello VRNexGen Team,

        I am unable to complete my signup because the verification token/link failed or expired.
