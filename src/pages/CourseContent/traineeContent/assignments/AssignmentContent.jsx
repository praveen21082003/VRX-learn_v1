...
function AssignmentContent() {
  ...
  useDocumentTitle(
    activeAssignment ? `${activeAssignment?.title} - Assignment` : "Assignment",
  );
  ...
  const { url, loading, error } = useViewUrl(
    assignmentId,
  ...
  const dueDateText =
    formattedDate === "N/A" ? "No due date provided" : formattedDate;
    ...
    <div className="overflow-y-auto w-full">
      ...
      >
        <div className=" flex justify-between">
          <div>
            <h1 className="flex gap-2 items-center text-h3">
          ...
          {submissions?.length > 0 && submissions?.length < maxAttempts && (
            <Button
              ...
              frontIconName={
                retake ? "radix-icons:cross-2" : "ic:baseline-loop"
              }
              frontIconHeight="26"
              frontIconWidth="26"
              bgClass=""
          ...
          <div className="mt-6 space-y-4">
            {attemptsArray.map((attemptNumber) => {
              ...
              return (
                <div
                  key={attemptNumber}
                  className="border rounded border-default overflow-hidden"
                >
                  <div
                  ...
                  >
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <Button
                        ...
                        textClass=""
                        className={
                          openAttempt === attemptNumber ? "rotate-180" : ""
                        }
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3 p-4">
                      <div className="flex justify-between items-center">
                        <div className="flex gap-2">
                          <Icon
                            name="fluent:document-pdf-24-filled"
                            height="36"
                            width="36"
                          />
